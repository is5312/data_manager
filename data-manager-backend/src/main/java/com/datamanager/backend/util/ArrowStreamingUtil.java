...
public class ArrowStreamingUtil {
    ...
    private static final int BATCH_SIZE = 10000; // Rows per batch
            ...
            try (VectorSchemaRoot root = VectorSchemaRoot.create(schema, allocator);
                ...
                while (resultSet.next()) {
                    ...
                    if (batchRowCount >= BATCH_SIZE) {
                        ...
                        log.debug("Wrote Arrow batch: {} rows (total: {})", batchRowCount, totalRows);
                ...
                if (batchRowCount > 0) {
                    root.setRowCount(batchRowCount);
                    writer.writeBatch();
                    log.debug("Wrote final Arrow batch: {} rows", batchRowCount);
                }
